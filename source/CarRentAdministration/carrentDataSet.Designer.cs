...
namespace CarRentAdministration {
    ...
    public partial class carrentDataSet : global::System.Data.DataSet {
        ...
        public partial class carDataTable : global::System.Data.TypedTableBase<carRow> {
            ...
            private global::System.Data.DataColumn columnKlassenId;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn KlassenIdColumn {
                get {
                    return this.columnKlassenId;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public carRow AddcarRow(int ID, string Marke, string Typ, int KlassenId) {
            ...
            internal void InitVars() {
                ...
                this.columnKlassenId = base.Columns["KlassenId"];
            }
            ...
            private void InitClass() {
                ...
                this.columnKlassenId = new global::System.Data.DataColumn("KlassenId", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnKlassenId);
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnID}, true));
                this.columnID.AllowDBNull = false;
                this.columnID.Unique = true;
                this.columnMarke.AllowDBNull = false;
                this.columnMarke.MaxLength = 45;
                this.columnTyp.AllowDBNull = false;
                this.columnTyp.MaxLength = 45;
                this.columnKlassenId.AllowDBNull = false;
            }
        ...
        public partial class carRow : global::System.Data.DataRow {
            ...
            public string Marke {
                get {
                    return ((string)(this[this.tablecar.MarkeColumn]));
                }
                set {
                    this[this.tablecar.MarkeColumn] = value;
                }
            }
            ...
            public string Typ {
                get {
                    return ((string)(this[this.tablecar.TypColumn]));
                }
                set {
                    this[this.tablecar.TypColumn] = value;
                }
            }
            ...
            public int KlassenId {
                get {
                    return ((int)(this[this.tablecar.KlassenIdColumn]));
                }
                set {
                    this[this.tablecar.KlassenIdColumn] = value;
                }
            }
        }
...
namespace CarRentAdministration.carrentDataSetTableAdapters {
    ...
    public partial class carTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("KlassenId", "KlassenId");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `car` WHERE ((`ID` = @p1) AND (`Marke` = @p2) AND (`Typ` = @p3) AND (" +
                "`KlassenId` = @p4))";
            ...
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.Int32;
            param.IsNullable = true;
            param.SourceColumn = "KlassenId";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            this._adapter.DeleteCommand.Parameters.Add(param);
            this._adapter.InsertCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `car` (`ID`, `Marke`, `Typ`, `KlassenId`) VALUES (@p1, @p2, @p3, @p4)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `car` SET `ID` = @p1, `Marke` = @p2, `Typ` = @p3, `KlassenId` = @p4 WHERE " +
                "((`ID` = @p5) AND (`Marke` = @p6) AND (`Typ` = @p7) AND (`KlassenId` = @p8))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CarRentAdministration.Properties.Settings.Default.carrentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `ID`, `Marke`, `Typ`, `KlassenId` FROM `car`";
        ...
        public virtual int Fill(carrentDataSet.carDataTable dataTable) {
        ...
        public virtual carrentDataSet.carDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            carrentDataSet.carDataTable dataTable = new carrentDataSet.carDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(carrentDataSet.carDataTable dataTable) {
